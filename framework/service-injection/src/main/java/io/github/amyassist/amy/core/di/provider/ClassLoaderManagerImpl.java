...
/**
 * Service implementation of the {@link ClassLoaderManager} to access all available ClassLoaders.
 * 
 * @author Leon Kiefer
 */
public class ClassLoaderManagerImpl implements ClassLoaderManager {
	...
	/**
	 * @param classLoaders
	 *            all classLoaders that are available for the ClassLoaderManager
	 */
	public ClassLoaderManagerImpl(Set<ClassLoader> classLoaders) {
